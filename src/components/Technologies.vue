...
<section id="technologies" class="py-20">
    <div class="mx-auto px-6">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold dark:text-light text-primary mb-6 text-center ">Technologies</h2>
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 items-center gap-6">
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">
                        JavaScript
                    </p>
                </div>
                ...
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        ...
                        class="transition-transform duration-300 group-hover:scale-110"
                        >
                    <g fill="none"><rect width="256" height="256" fill="#f7f5f3" rx="60"/><path fill="#41b883" d="M182 50h36l-90 155.25L38 50h68.85L128 86l20.7-36z"/><path fill="#41b883" d="m38 50l90 155.25L218 50h-36l-54 93.15L73.55 50z"/><path fill="#35495e" d="M73.55 50L128 143.6L182 50h-33.3L128 86l-21.15-36z"/></g></svg>               
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">Vue.js</p>
                </div>
                 <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                ...
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">HTML</p>
                </div>
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">CSS</p>
                </div>
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        ...
                        class="transition-transform duration-300 group-hover:scale-110"
                    >
                    <g fill="none"><rect width="256" height="256" fill="#f4f2ed" rx="60"/><path fill="url(#skillIconsTailwindcssLight0)" fill-rule="evenodd" d="M83 110q9-36 45-36c36 0 40.5 27 58.5 31.5q18 4.502 31.5-13.5q-9 36-45 36c-36 0-40.5-27-58.5-31.5Q96.5 92 83 110m-45 54q9-36 45-36c36 0 40.5 27 58.5 31.5q18 4.502 31.5-13.5q-9 36-45 36c-36 0-40.5-27-58.5-31.5q-18-4.502-31.5 13.5" clip-rule="evenodd"/><defs><linearGradient id="skillIconsTailwindcssLight0" x1="86.5" x2="163.5" y1="74" y2="185.5" gradientUnits="userSpaceOnUse"><stop stop-color="#32b1c1"/><stop offset="1" stop-color="#14c6b7"/></linearGradient></defs></g></svg>                
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">Tailwind CSS</p>
                </div>
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        ...
                        class="transition-transform duration-300 group-hover:scale-110"
                    >
                    <g fill="none"><rect width="256" height="256" fill="#2396ed" rx="60"/><path fill="#fff" d="M141.187 122.123h20.717v-18.744h-20.717zm-24.662 0h20.716v-18.744h-20.716zm-24.17 0h20.717v-18.744H92.355zm-24.17 0H88.41v-18.744H68.186zm-24.662 0H64.24v-18.744H43.523zm24.663-22.69h20.223V80.69H68.186zm24.17 0h20.716V80.69H92.355zm24.169 0h20.716V80.69h-20.716zm0-22.69h20.716V58h-20.716zM228 113.739s-8.879-8.386-27.129-5.426c-1.973-14.305-17.264-22.69-17.264-22.69s-14.304 17.264-3.946 36.501c-2.959 1.48-7.892 3.453-15.291 3.453H28.726c-2.467 9.372-2.467 71.521 65.602 71.521c48.832 0 85.333-22.689 102.597-64.123C222.574 134.948 228 113.738 228 113.738"/></g></svg>               
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">Docker</p>
                </div>
                ...
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        ...
                        viewBox="0 0 256 256"
                        class="transition-transform duration-300 group-hover:scale-110"
                    ><g fill="none"><g clip-path="url(#skillIconsVuetifyLight0)"><path fill="#f4f2ed" d="M196 0H60C26.863 0 0 26.863 0 60v136c0 33.137 26.863 60 60 60h136c33.137 0 60-26.863 60-60V60c0-33.137-26.863-60-60-60"/><g clip-path="url(#skillIconsVuetifyLight1)"><path fill="#1697f6" d="m129.353 102.949l-34.892 60.569l33.039 57.373l43.76-75.945L215 69h-66.098z"/><path fill="#aeddff" d="m83.76 144.946l2.291 3.994l32.641-56.675L132.103 69H40z"/><path fill="#1867c0" d="M148.902 69c16.539 54.538-21.402 151.891-21.402 151.891l-33.04-57.373z"/><path fill="#7bc6ff" d="M132.103 69c-69.685 0-46.051 79.94-46.051 79.94z"/></g></g><defs><clipPath id="skillIconsVuetifyLight0"><path fill="#fff" d="M0 0h256v256H0z"/></clipPath><clipPath id="skillIconsVuetifyLight1"><path fill="#fff" d="M40 69h175v152H40z"/></clipPath></defs></g></svg>
                    <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">Vuetify</p>
                </div>
                <div class="group text-center flex flex-col items-center justify-center p-4">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
               ...
               <div class="group text-center flex flex-col items-center justify-center p-4">
                  ...
                  <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">Formik</p>
               </div>
               <div class="group text-center flex flex-col items-center justify-center p-4">
                  <svg
                  xmlns="http://www.w3.org/2000/svg"
               ...
               <div class="group text-center flex flex-col items-center justify-center p-4">
                  ...
                  <p class="mt-2 text-gray-600 dark:text-gray-400 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300">React Router</p>
               </div>
